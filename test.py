...
def get_opt():
    ...
    # ------------------------------------------------------------------------
    # parser.add_argument("--data_list", default="test_pairs_pants_GMM.txt")
    # parser.add_argument("--data_list", default="test_pairs_cloths_GMM.txt")
    # parser.add_argument("--data_list", default="test_pairs_pants_TOM.txt")
    parser.add_argument("--data_list", default="test_pairs_cloths_TOM.txt")
    # ------------------------------------------------------------------------
    ...
    # parser.add_argument('--checkpoint', type=str, default='checkpoints/GMM/GMM_pant_model.pth', help='model checkpoint for test')
    parser.add_argument('--checkpoint', type=str, default='checkpoints/TOM/cloth_TOM.pth', help='model checkpoint for test')
...
def test_gmm(opt, test_loader, model, board):  # GMM
    model.cuda()
    model.eval()
...
def test_tom(opt, test_loader, model, board):  # TOM
    model.cuda()
    model.eval()
